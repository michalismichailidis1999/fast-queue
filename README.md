...
4. Log based storage (appending messages to end of a file)
5. Custom B-Tree indexing for faster message retrieval by consumers
6. Asynchronous message replication
7. Connection pooling + handling of idle connections
