...
int main(int argc, char* argv[])
{
    ...
    std::unique_ptr<ClusterMetadataApplyHandler> cmah = std::unique_ptr<ClusterMetadataApplyHandler>(new ClusterMetadataApplyHandler(qm.get(), fh.get(), pm.get(), settings.get()));
