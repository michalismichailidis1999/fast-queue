...
int main(int argc, char* argv[])
{
    ...
    std::unique_ptr<DataNode> data_node = std::unique_ptr<DataNode>(new DataNode(controller.get(), cm.get(), qm.get(), mh.get(), request_mapper.get(), response_mapper.get(), transformer.get(), util.get(), fh.get(), settings.get(), server_logger.get()));
