...
enum class RequestType {
	...
	EXPIRE_CONSUMERS,
	ADD_LAGGING_FOLLOWER,
	REMOVE_LAGGING_FOLLOWER,
	FETCH_MESSAGES,
	UNREGISTER_TRANSACTION_GROUP,
	TRANSACTION_STATUS_UPDATE,
	RETRIEVE_QUEUE_PARTITIONS_INFO,
	RETRIEVE_PARTITION_OFFSET_INFO,
...
enum class ErrorCode {
	...
	DATA_NODE_NOT_REGISTERED_YET,
	TRANSACTION_GROUP_NOT_FOUND,
	TRANSACTION_GROUP_UNREGISTERED,
	QUEUE_ASSIGNED_TO_TRANSACTION_GROUP,
	MAX_CONNECTIONS_LIMIT_REACHED
};
...
enum class ResponseValueKey {
	...
	COMMITED_OFFSET,
	PREV_MESSAGE_OFFSET,
	PREV_MESSAGE_LEADER_EPOCH,
	CONSUMERS_ACKS,
	REPLICATION_FACTOR,
	PARTITION_LAST_OFFSET,
	PARTITION_LAST_COMMITED_OFFSET,
	QUEUE_PARTITION_INFO
};
