...
static const unsigned int INDEX_PAGE_OFFSET_SIZE = sizeof(unsigned int);
...
static const unsigned int INDEX_PAGE_METADATA_SIZE = COMMON_METADATA_TOTAL_BYTES + INDEX_PAGE_TYPE_SIZE + INDEX_PAGE_MIN_KEY_SIZE + INDEX_PAGE_MAX_KEY_SIZE + INDEX_PAGE_NUM_OF_ROWS_SIZE;

static const unsigned int INDEX_KEY_SIZE = sizeof(unsigned long long);
static const unsigned int INDEX_KEY_OFFSET = 0;
static const unsigned int INDEX_VALUE_POSITION_SIZE = sizeof(unsigned int);
...
static const unsigned int PARTITION_ID_SIZE = sizeof(unsigned int);
static const unsigned int PARTITION_ID_OFFSET = COMMON_METADATA_TOTAL_BYTES;
static const unsigned int PARTITION_CURRENT_SEGMENT_SIZE = sizeof(unsigned long long);
static const unsigned int PARTITION_CURRENT_SEGMENT_OFFSET = PARTITION_ID_SIZE + PARTITION_ID_OFFSET;
static const unsigned int PARTITION_OLDEST_SEGMENT_SIZE = sizeof(unsigned long long);
static const unsigned int PARTITION_OLDEST_SEGMENT_OFFSET = PARTITION_CURRENT_SEGMENT_SIZE + PARTITION_CURRENT_SEGMENT_OFFSET;
static const unsigned int PARTITION_TOTAL_SEGMENTS_SIZE = sizeof(unsigned long long);
static const unsigned int PARTITION_TOTAL_SEGMENTS_OFFSET = PARTITION_OLDEST_SEGMENT_SIZE + PARTITION_OLDEST_SEGMENT_OFFSET;
static const unsigned int PARTITION_METADATA_TOTAL_BYTES = COMMON_METADATA_TOTAL_BYTES + PARTITION_ID_SIZE + PARTITION_CURRENT_SEGMENT_SIZE
...
static const unsigned int SEGMENT_OLDEST_MESSAGE_TMSTMP_SIZE = sizeof(unsigned long long);
static const unsigned int SEGMENT_OLDEST_MESSAGE_TMSTMP_OFFSET = SEGMENT_ID_SIZE + SEGMENT_ID_OFFSET;
static const unsigned int SEGMENT_NEWEST_MESSAGE_TMSTMP_SIZE = sizeof(unsigned long long);
static const unsigned int SEGMENT_NEWEST_MESSAGE_TMSTMP_OFFSET = SEGMENT_OLDEST_MESSAGE_TMSTMP_SIZE + SEGMENT_OLDEST_MESSAGE_TMSTMP_OFFSET;
static const unsigned int SEGMENT_OLDEST_MESSAGE_OFF_SIZE = sizeof(unsigned long long);
static const unsigned int SEGMENT_OLDEST_MESSAGE_OFF_OFFSET = SEGMENT_NEWEST_MESSAGE_TMSTMP_SIZE + SEGMENT_NEWEST_MESSAGE_TMSTMP_OFFSET;
static const unsigned int SEGMENT_NEWEST_MESSAGE_OFF_SIZE = sizeof(unsigned long long);
static const unsigned int SEGMENT_NEWEST_MESSAGE_OFF_OFFSET = SEGMENT_OLDEST_MESSAGE_OFF_SIZE + SEGMENT_OLDEST_MESSAGE_OFF_OFFSET;
static const unsigned int SEGMENT_IS_READ_ONLY_SIZE = sizeof(bool);
static const unsigned int SEGMENT_IS_READ_ONLY_OFFSET = SEGMENT_NEWEST_MESSAGE_OFF_SIZE + SEGMENT_NEWEST_MESSAGE_OFF_OFFSET;
...
static const unsigned int SEGMENT_METADATA_TOTAL_BYTES = COMMON_METADATA_TOTAL_BYTES + SEGMENT_ID_SIZE + SEGMENT_OLDEST_MESSAGE_TMSTMP_SIZE 
+ SEGMENT_NEWEST_MESSAGE_TMSTMP_SIZE + SEGMENT_OLDEST_MESSAGE_OFF_SIZE + SEGMENT_NEWEST_MESSAGE_OFF_SIZE
+ SEGMENT_IS_READ_ONLY_SIZE + SEGMENT_IS_COMPACTED_SIZE + SEGMENT_LAST_INDEX_PAGE_OFFSET_SIZE;
