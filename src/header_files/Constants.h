...
static const int QUEUE_LAST_COMMIT_INDEX_SIZE = sizeof(unsigned long long);
static const int QUEUE_LAST_COMMIT_INDEX_OFFSET = QUEUE_REPLICATION_FACTOR_SIZE + QUEUE_REPLICATION_FACTOR_OFFSET;
static const int QUEUE_LAST_APPLIED_INDEX_SIZE = sizeof(unsigned long long);
static const int QUEUE_LAST_APPLIED_INDEX_OFFSET = QUEUE_LAST_COMMIT_INDEX_SIZE + QUEUE_LAST_COMMIT_INDEX_OFFSET;
static const int QUEUE_METADATA_TOTAL_BYTES = COMMON_METADATA_TOTAL_BYTES + QUEUE_NAME_SIZE + QUEUE_NAME_LENGTH_SIZE 
