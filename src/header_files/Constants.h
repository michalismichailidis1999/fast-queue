...
static const unsigned int QUEUE_COMPACT_SEGMENTS_SIZE = sizeof(bool);
static const unsigned int QUEUE_COMPACT_SEGMENTS_OFFSET = QUEUE_LAST_APPLIED_INDEX_SIZE + QUEUE_LAST_APPLIED_INDEX_OFFSET;
static const unsigned int QUEUE_METADATA_TOTAL_BYTES = COMMON_METADATA_TOTAL_BYTES + QUEUE_NAME_SIZE + QUEUE_NAME_LENGTH_SIZE 
+ QUEUE_PARTITIONS_SIZE + QUEUE_REPLICATION_FACTOR_SIZE + QUEUE_LAST_COMMIT_INDEX_SIZE + QUEUE_LAST_APPLIED_INDEX_SIZE + QUEUE_COMPACT_SEGMENTS_SIZE;
