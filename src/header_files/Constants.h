...
static const std::string PIPES_QUEUE_NAME = "__pipes";

static const std::string IPC_RECEIVER_PIPE_NAME = "ipc_receiver.pipe";
static const unsigned int IPC_REQUEST_BYTES = 4096;
static const unsigned int IPC_RESPONSE_BYTES = 4096;
...
static const unsigned int MAX_TRANSACTION_SEGMENT_SIZE = 104857600; // 100MB
...
static const unsigned int MESSAGE_COMMIT_STATUS_SIZE = sizeof(int);
static const unsigned int MESSAGE_COMMIT_STATUS_OFFSET = MESSAGE_IS_ACTIVE_SIZE + MESSAGE_IS_ACTIVE_OFFSET;
static const unsigned int MESSAGE_LEADER_ID_SIZE = sizeof(unsigned long long);
static const unsigned int MESSAGE_LEADER_ID_OFFSET = MESSAGE_COMMIT_STATUS_SIZE + MESSAGE_COMMIT_STATUS_OFFSET;
...
+ MESSAGE_COMMIT_STATUS_SIZE + MESSAGE_LEADER_ID_SIZE + MESSAGE_KEY_SIZE + MESSAGE_PAYLOAD_SIZE;
...
+ SEGMENT_LAST_MESSAGE_OFF_SIZE + SEGMENT_IS_READ_ONLY_SIZE + SEGMENT_IS_COMPACTED_SIZE;
...
static const unsigned int PLA_COMMAND_LEADER_ID_SIZE = sizeof(unsigned long long);
static const unsigned int PLA_COMMAND_LEADER_ID_OFFSET = PLA_COMMAND_PARTITION_SIZE + PLA_COMMAND_PARTITION_OFFSET;
static const unsigned int PLA_COMMAND_NEW_LEADER_SIZE = sizeof(unsigned int);
static const unsigned int PLA_COMMAND_NEW_LEADER_OFFSET = PLA_COMMAND_LEADER_ID_SIZE + PLA_COMMAND_LEADER_ID_OFFSET;
...
+ PLA_COMMAND_PARTITION_SIZE + PLA_COMMAND_LEADER_ID_SIZE + PLA_COMMAND_NEW_LEADER_SIZE + PLA_COMMAND_PREV_LEADER_SIZE;
...
static const unsigned int ALF_COMMAND_QUEUE_NAME_LENGTH_SIZE = sizeof(unsigned int);
static const unsigned int ALF_COMMAND_QUEUE_NAME_LENGTH_OFFSET = COMMAND_TOTAL_BYTES;
static const unsigned int ALF_COMMAND_QUEUE_NAME_SIZE = sizeof(char) * MAX_QUEUE_NAME_CHARS;
static const unsigned int ALF_COMMAND_QUEUE_NAME_OFFSET = ALF_COMMAND_QUEUE_NAME_LENGTH_SIZE + ALF_COMMAND_QUEUE_NAME_LENGTH_OFFSET;
static const unsigned int ALF_COMMAND_PARTITION_ID_SIZE = sizeof(int);
static const unsigned int ALF_COMMAND_PARTITION_ID_OFFSET = ALF_COMMAND_QUEUE_NAME_SIZE + ALF_COMMAND_QUEUE_NAME_OFFSET;
static const unsigned int ALF_COMMAND_NODE_ID_SIZE = sizeof(int);
static const unsigned int ALF_COMMAND_NODE_ID_OFFSET = ALF_COMMAND_PARTITION_ID_SIZE + ALF_COMMAND_PARTITION_ID_OFFSET;
static const unsigned int ALF_COMMAND_TOTAL_BYTES = COMMAND_TOTAL_BYTES + ALF_COMMAND_QUEUE_NAME_LENGTH_SIZE + ALF_COMMAND_QUEUE_NAME_SIZE
+ ALF_COMMAND_PARTITION_ID_SIZE + ALF_COMMAND_NODE_ID_SIZE;

static const unsigned int RLF_COMMAND_QUEUE_NAME_LENGTH_SIZE = sizeof(unsigned int);
static const unsigned int RLF_COMMAND_QUEUE_NAME_LENGTH_OFFSET = COMMAND_TOTAL_BYTES;
static const unsigned int RLF_COMMAND_QUEUE_NAME_SIZE = sizeof(char) * MAX_QUEUE_NAME_CHARS;
static const unsigned int RLF_COMMAND_QUEUE_NAME_OFFSET = RLF_COMMAND_QUEUE_NAME_LENGTH_SIZE + RLF_COMMAND_QUEUE_NAME_LENGTH_OFFSET;
static const unsigned int RLF_COMMAND_PARTITION_ID_SIZE = sizeof(int);
static const unsigned int RLF_COMMAND_PARTITION_ID_OFFSET = RLF_COMMAND_QUEUE_NAME_SIZE + RLF_COMMAND_QUEUE_NAME_OFFSET;
static const unsigned int RLF_COMMAND_NODE_ID_SIZE = sizeof(int);
static const unsigned int RLF_COMMAND_NODE_ID_OFFSET = RLF_COMMAND_PARTITION_ID_SIZE + RLF_COMMAND_PARTITION_ID_OFFSET;
...
static const unsigned int TX_CHANGE_TOTAL_BYTES = TX_CHANGE_GROUP_ID_SIZE + TX_CHANGE_ID_SIZE + TX_CHANGE_STATUS_SIZE + TX_CHANGE_TIMESTAMP_SIZE;

static const unsigned int TX_MSG_CAPTURE_TX_GROUP_ID_SIZE = sizeof(unsigned long long);
static const unsigned int TX_MSG_CAPTURE_TX_GROUP_ID_OFFSET = 0;
static const unsigned int TX_MSG_CAPTURE_TX_ID_SIZE = sizeof(unsigned long long);
static const unsigned int TX_MSG_CAPTURE_TX_ID_OFFSET = TX_MSG_CAPTURE_TX_GROUP_ID_SIZE + TX_MSG_CAPTURE_TX_GROUP_ID_OFFSET;
...
static const unsigned int TX_MSG_CAPTURE_QUEUE_NAME_LENGTH_SIZE = sizeof(unsigned int);
static const unsigned int TX_MSG_CAPTURE_QUEUE_NAME_LENGTH_OFFSET = TX_MSG_CAPTURE_SEG_ID_SIZE + TX_MSG_CAPTURE_SEG_ID_OFFSET;
static const unsigned int TX_MSG_CAPTURE_QUEUE_NAME_SIZE = sizeof(char) * MAX_QUEUE_NAME_CHARS;
static const unsigned int TX_MSG_CAPTURE_QUEUE_NAME_OFFSET = TX_MSG_CAPTURE_QUEUE_NAME_LENGTH_SIZE + TX_MSG_CAPTURE_QUEUE_NAME_LENGTH_OFFSET;
static const unsigned int TX_MSG_CAPTURE_PARTITION_ID_SIZE = sizeof(unsigned int);
static const unsigned int TX_MSG_CAPTURE_PARTITION_ID_OFFSET = TX_MSG_CAPTURE_QUEUE_NAME_SIZE + TX_MSG_CAPTURE_QUEUE_NAME_OFFSET;
static const unsigned int TX_MSG_CAPTURE_TOTAL_BYTES = TX_MSG_CAPTURE_TX_GROUP_ID_SIZE + TX_MSG_CAPTURE_TX_ID_SIZE + TX_MSG_CAPTURE_STATUS_SIZE + TX_MSG_CAPTURE_TIMESTAMP_SIZE
...
+ TX_MSG_CAPTURE_QUEUE_NAME_LENGTH_SIZE + TX_MSG_CAPTURE_QUEUE_NAME_SIZE + TX_MSG_CAPTURE_PARTITION_ID_SIZE;
