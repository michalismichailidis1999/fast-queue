...
static const int COMMON_METADATA_TOTAL_BYTES = TOTAL_METADATA_BYTES + VERSION_SIZE_OFFSET;
...
static const int PARTITION_ID_SIZE = sizeof(int);
...
static const int PARTITION_METADATA_TOTAL_BYTES = PARTITION_ID_SIZE + PARTITION_CURRENT_SEGMENT_SIZE
...
static const int SEGMENT_TOTAL_MESSAGES_SIZE = sizeof(int);
static const int SEGMENT_TOTAL_MESSAGES_OFFSET = SEGMENT_ID_SIZE + SEGMENT_ID_OFFSET;
static const int SEGMENT_OLDEST_MESSAGE_TMSTMP_SIZE = sizeof(std::chrono::milliseconds);
static const int SEGMENT_OLDEST_MESSAGE_TMSTMP_OFFSET = SEGMENT_TOTAL_MESSAGES_SIZE + SEGMENT_TOTAL_MESSAGES_OFFSET;
static const int SEGMENT_NEWEST_MESSAGE_TMSTMP_SIZE = sizeof(std::chrono::milliseconds);
...
static const int SEGMENT_METADATA_TOTAL_BYTES = SEGMENT_ID_SIZE + SEGMENT_TOTAL_MESSAGES_SIZE 
+ SEGMENT_OLDEST_MESSAGE_TMSTMP_SIZE + SEGMENT_NEWEST_MESSAGE_TMSTMP_SIZE;