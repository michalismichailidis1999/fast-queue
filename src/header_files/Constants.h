...
static const int COMMAND_TYPE_OFFSET = COMMON_METADATA_TOTAL_BYTES;
...
static const int COMMAND_METADATA_VERSION_SIZE = sizeof(unsigned long long);
static const int COMMAND_METADATA_VERSION_OFFSET = COMMAND_TERM_SIZE + COMMAND_TERM_OFFSET;
static const int COMMAND_TIMESTAMP_SIZE = sizeof(unsigned long long);
static const int COMMAND_TIMESTAMP_OFFSET = COMMAND_METADATA_VERSION_SIZE + COMMAND_METADATA_VERSION_OFFSET;
static const int COMMAND_TOTAL_BYTES = COMMON_METADATA_TOTAL_BYTES + COMMAND_TYPE_SIZE + COMMAND_TERM_SIZE + COMMAND_METADATA_VERSION_SIZE
+ COMMAND_TIMESTAMP_SIZE;
