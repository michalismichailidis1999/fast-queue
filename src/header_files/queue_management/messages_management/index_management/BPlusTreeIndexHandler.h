...
public:
	...
	void add_message_to_index(Partition* partition, unsigned long long message_id, long long message_pos, bool cache_pages = true, PartitionSegment* segment_to_write = NULL);
};